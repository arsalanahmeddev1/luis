        ...
        <div class="row align-items-center text-center">
            ...
            <div class="col-lg-3 col-md-12">
                <div class="artboard-book-area position-relative">
                    <a href="#"> <img src="{{asset('assets/images/Group 3.png')}}" class="ani-penta-top-book"
                            alt=""> </a>
                    <div class="old-text">
                        ...
                        <div class="artboard-books">
                            ...
                            <div class="artboard-book">
                                <a href="#"><img id="book-15"
                                        ...
                                        data-id="{{asset('assets/images/old-testament-images/old-testament-book-covers/Exodus.png')}}"
                                        class="img-fluid sm-book" alt=""></a>
                            </div>
                            <div class="artboard-book">
                                <a href="#"><img id="book-16"
                                        ...
                                        data-id="{{asset('assets/images/old-testament-images/old-testament-book-covers/Numbers.png')}}"
                                        class="img-fluid sm-book" alt=""></a>
                            </div>
                            <div class="artboard-book">
                                <a href="#"><img id="book-17"
                                        ...
                                        data-id="{{asset('assets/images/old-testament-images/old-testament-book-covers/Leviticus.png')}}"
                                        class="img-fluid sm-book" alt=""></a>
                            </div>
                        </div>
